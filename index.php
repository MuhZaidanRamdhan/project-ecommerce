...
<body style="background-color:#f2f6fc;">
  ...
  <section class="section-hero">
    <main class="content">
      ...
      <a href="login.php" class="cta">JOIN US</a>
    </main>
  </section>
          ...
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body" style="padding:0;">
                ...
                <p class="card-text" id="about-para1">website yang menyediakan layanan dan produk kitchen set berkaitan
                  dengan meningkatnya minat dan kebutuhan masyarakat akan desain interior yang lebih fungsional dan
          ...
          <div class="row g-0">
            <div class="col-md-8">
              <div class="card-body" style="padding:0;">
                ...
                <p class="card-text" id="about-para2">masyarakat dapat dengan mudah mencari dan memilih model kitchen
                  set yang sesuai dengan kebutuhan dan budget mereka tanpa harus datang ke toko fisik secara langsung.
                </p>
              </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="card" style=" width: 17rem; height: 25rem;">
          ...
          <div class="card-body">
            <h6 class="card-title">
              ...
              <a href="detail.php?id=<?= $row['id'] ?>" class="btn btn-secondary" id="but-detail">Detail Produk</a>
          </div>
        </div>
      </div>
      <?php
  ...
  <section class="section-owner">
    <div class="qoutes-body">
      <h5 class="qoutes">“ Garlic merupakan aplikasi pembelian barang peralatan dapur rumah,<br>dalam membantu ibu-ibu
        ...
        <section class="">
          ...
          <div class="row">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
              <h6 class="text-uppercase mb-4 font-weight-bold" style=" color:#F2F6FC;">Jelajahi GARLIC.ID</h6>
              <p>
