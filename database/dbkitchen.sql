...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2023 at 03:24 PM
...
(1, 'Fakhirul', 'L', '085100001234', 'fakhirul@gmail.com', 'Bekasi', 1),
...
(1, 'PO001', '2023-02-02 00:00:00', 2, 432000, 1, 7),
...
INSERT INTO `product` (`id`, `sku`, `name`, `purchase_price`, `sell_price`, `stock`, `min_stock`, `product_type_id`, `restock_id`, `foto`) VALUES
(1, 'SK001', 'Cutting Board', 100000, 140000, 21, 1, 1, 1, 'CuttingBoard.jpg'),
(2, 'SK002', 'Mixer', 120000, 200000, 18, 1, 1, 1, 'Mixer.jpeg'),
(3, 'SK003', 'Black Pan', 100000, 145000, 15, 1, 1, 1, 'BlackPan.jpeg'),
(4, 'SK004', 'Microwave', 230000, 270000, 23, 1, 2, 2, 'MicroWave.jpeg'),
(5, 'SK005', 'Rice Cooker', 150000, 215000, 6, 1, 1, 2, 'RiceCooker.jpeg'),
(6, 'SK006', 'Butcher Knife', 150000, 170000, 12, 5, 1, 1, 'PisauDaging.jpg'),
(7, 'SK007', 'Pressure Cooker', 250000, 290000, 8, 2, 1, 1, 'PressureCooker.jpeg'),
(8, 'SK008', 'Blender', 75000, 140000, 9, 4, 1, 1, 'Blender.jpg');
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `fk_order_customer` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_order_product1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
