...
<section class="detail-card">
  ...
  <div class="row g-0" id="card-row">
    <div class="col-md-6" id="card-too">
      <img src="assets/<?= $row['foto']?>" class="img-fluid" alt="..."  style=" background-size:cover;background-position:center; height:480px;width:480px; aspect-ratio:1/1; ">
    </div>
    <div class="col-md-6" id="desain-card">
      <div class="card-body">
        <h5 class="card-title" id="title-sku"><?= $row['sku'] ?></h5>
        <p id="title-name"><?= $row['name'] ?></p>
        <p id="title-price">Rp <?=  number_format ($row['sell_price'],0,',','.')  ?></p>
        <p id="title-stock">Stok Tersedia : <?= $row['stock'] ?></p>
    <form action="login.php" class="f-flex">
  <input type="number" class="form-control" id="input-numb" placeholder="" aria-label="pesan" aria-describedby="basic-addon1" min="1"> 
...
<div data-aos="fade-up"
  ...
  <div class="card" style=" width: 17rem; height: 25rem;">
    <img src="assets/<?= $row['foto']?>" class="card-img-top" alt="..." width="40%" height="50%" style="object-fit:1/1; background-size:cover; background-position:center;">
    <div class="card-body">
    <h6 class="card-title"><?= $row['sku'] ?></h5>
      <h5 class="card-title"><?= $row['name'] ?></h5>
      <p class="card-text">Rp <?= number_format ($row['sell_price'],0,',','.') ?></p>
  ...
  <footer
          ...
          style="background-color: #081b29;" id="footer-marg"
          >
    <!-- Grid container -->
