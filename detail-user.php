            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item" id="list-demo">
                        <a class="nav-link active" aria-current="page" href="starter-user.php" id="linked">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="starter-user.php" id="linked">About</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card" style=" width: 17rem; height: 25rem;">
                    ...
                    <div class="card-body">
                        <h6 class="card-title">
                            ...
                            <a href="detail-user.php?id=<?= $row['id'] ?>" class="btn btn-secondary">Detail Produk</a>
                    </div>
                </div>
            </div>
            </div>
