    ...
    <nav class="navbar navbar-expand-lg" id="container">
        <div class="container-fluid" id="contain-nav">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <img class="nav-link" src="assets/owner.jpg" id="logo-user"></img>
                </ul>
            </div>
        </div>
    </nav>
                ...
                <div class="card" style=" width: 17rem; height: 25rem;">
                    ...
                    <div class="card-body">
                        <h6 class="card-title">
                            ...
                            <a href="detail.php?id=<?= $row['id'] ?>" class="btn btn-secondary" id="but-detail">Detail
                                Produk</a>
                    </div>
                </div>
            </div>
    ...
    <section class="section-owner">
        <div class="qoutes-body">
            <h5 class="qoutes">“ Garlic merupakan aplikasi pembelian barang peralatan dapur rumah,<br>dalam membantu
                ibu-ibu menemukan kebutuhannya. Sehingga ibu-ibu tidak perlu datang ke toko secara langsung.”</h5>
        </div>
